...
<body class="bg-light">
    <div class="container-fluid">
        ...
        <input type="text" class="form-control mb-3" name="name/email" placeholder="Username/Email..." autofocus="true"/>
        <input type="password" class="form-control mb-3" name="usersPwd" placeholder="Password..."/>
        <a href="./Customerreset-password.php" id="forgot_password" data-target="#forgotPasswordModal" div class="form-sub-msg">Forgot Password?</a>
...
<div id="button_container" class="text-center mt-3" name="submit">
                        ...
                        <p id="create_account_text" class="text-center mt-3">Don't have an account? <br> Create a new one <a href="Customersignup.php"> here</a></p>
